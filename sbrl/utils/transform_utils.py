...
euler2quat = lambda euler: T.euler_to_quat(euler)[[1,2,3,0]]
quat2euler = lambda quat: T.quat_to_euler(quat[[3,0,1,2]])

euler2quat_ext = lambda euler: R.from_euler("xyz", euler).as_quat()
quat2euler_ext = lambda quat: R.from_quat(quat).as_euler("xyz")
...
if __name__ == '__main__':
    ...
    for i in range(1000):
        ...
        with timeit("quat2euler"):
            _ = quat2euler_ext(quat)

        with timeit("fast_quat2euler"):
            eul_fast_from_quat = fast_quat2euler_ext(quat)

        quat_of_eul_fast_from_quat = euler2quat_ext(eul_fast_from_quat)
