...
EXPERIMENT_NAME = "sliderBlock2D/primitives"  # sac_collect_for_classify_updated"
DEVICE = "cpu"
...
def policy_next_params_fn(policy_idx: int, model: Model, obs: d, goal: d, memory: d = d(), **kwargs):
    ...
    if memory.reset_count < memory.max_iters:
        ...
        pps = d(
            ...
            kp_vel=1.5,
            speed_scale=np.random.uniform(1, 2.),
        ...
        if policy_idx == 0:
            ...
            pps.grab_force = np.random.uniform(750, 950)  # high
