...
RENDER = False
REALTIME = RENDER
DISABLE_IMAGES = True  # this means don't even compute surface images
HORIZON = 20

NUM_COLLECTIONS_PER_ENV_RESET = 1  # TODO modulate this
...
def policy_next_params_fn(policy_idx: int, model: Model, obs: d, goal: d, memory: d = d(), **kwargs):
    ...
    if memory.reset_count < NUM_COLLECTIONS_PER_ENV_RESET:
        random_policy_idx = np.random.choice([0, 1], p=[0.3, 0.7])
        # PULL
